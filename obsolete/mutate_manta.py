...
from manta_hic.ops.seq_ops import make_quiescent_seq, open_fasta_chromsizes
...
def manta_mutate_file(device, filename, out_filename, microzoi_file, fasta_file, model_wildcard):
    ...
    microzoi = Microzoi(return_type="mha")
    ...
    for i in glob.glob(model_wildcard):
        ...
        manta = Manta(output_channels=output_channels, tower_height=2)
